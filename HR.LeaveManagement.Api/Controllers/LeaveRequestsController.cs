...
public class LeaveRequestsController : ControllerBase
{
    ...
    [HttpGet]
    public async Task<ActionResult<List<LeaveRequestListDto>>> GetLeaveRequests(bool isLoggedInUser = false)
    {
    ...
    [HttpGet("{id}")]
    public async Task<ActionResult<LeaveRequestDetailsDto>> GetLeaveRequestById(int id)
    {
    ...
    public async Task<ActionResult> CreateLeaveRequest(CreateLeaveRequestCommand leaveRequest)
    {
        ...
        return CreatedAtAction(nameof(CreateLeaveRequest), new { id = response });
    }
